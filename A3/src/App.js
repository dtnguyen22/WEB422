          ...
          <Navbar.Collapse>
            <Nav>
              ...
              <NavDropdown title="Previously Viewed" id="basic-nav-dropdown">
                {recentlyViewed.length > 0 ? recentlyViewed.map((id, index)=>( <LinkContainer to={`/Sale/${id}`} key={index}><MenuItem >Sale: {id}</MenuItem></LinkContainer> )) : <MenuItem>...</MenuItem>}
              </NavDropdown>
            </Nav>
            <Navbar.Form pullRight>
              ...
              <Link className="btn btn-default" to={"/Sale/" + searchId}>
                Search
              </Link>
            </Navbar.Form>
          </Navbar.Collapse>
